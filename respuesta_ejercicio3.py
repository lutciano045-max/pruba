...
codigopais = input('Ingrese el codigo de pais: ')
area = input('Ingrese el codigo de area: ')
numero = input('Ingrese el numero de telefono: ')
extension = input('Ingrese el numero de extencion : ')

print("+"+codigopais+"-"+area+"-"+numero+"-"+extension)
